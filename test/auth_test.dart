...
void main() {
  group('Mock Authenticatio', () {
    ...
    test('User sholud be null after initialization', () {
      expect(
    ...
    test('Create user should delegate to login dunction ', () async {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> login({
    ...
    if (!isInitialized) throw NotINitialisedException();
    if (email == 'ad@i.com') throw UserNotFoundAuthException();
